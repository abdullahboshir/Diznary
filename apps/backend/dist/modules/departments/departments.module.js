...
const departments_mongoose_repository_1 = require("./repositories/departments.mongoose.repository");
...
exports.DepartmentsModule = DepartmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: departments_repository_interface_1.IDepartmentsRepository,
                useClass: departments_mongoose_repository_1.DepartmentsMongooseRepository,
            },
        ],
    })
], DepartmentsModule);
